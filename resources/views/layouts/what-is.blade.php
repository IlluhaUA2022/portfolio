<div class=" px-4 lg:px-8 mx-auto max-w-screen-xl text-gray-700 overflow-x-hidden">

<div class="mt-28">
    <div class="text-center max-w-screen-md mx-auto">
        <h1 class="text-3xl text-sky-800 font-bold mb-4">What is<span class="text-yellow-500"> Skilline?</span></h1>
    ...
    <div class="flex flex-col md:flex-row justify-center space-y-5 md:space-y-0 md:space-x-6 lg:space-x-10 mt-7">
