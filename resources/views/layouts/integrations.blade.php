...
<div class="container px-4 lg:px-8 mx-auto max-w-screen-xl text-gray-700 overflow-x-hidden">
    ...
    <button class="px-5 py-3 border border-yellow-500 text-yellow-500 font-medium my-14 focus:outline-none transform transition hover:scale-110 duration-300 ease-in-out rounded-full mx-auto block">See more features</button>

    <!-- INTEGRATIONS -->
    <div class="mt-24 flex flex-col md:flex-row items-start md:space-x-10">
        <div class="md:w-6/12">
            <img class="md:w-8/12 mx-auto" src="img/integrations.png" alt="integrations">
            <a href="#" title="Show" rel="nofollow noindex" target="_self">Click</a>
        </div>
        <div  class="md:w-6/12">
