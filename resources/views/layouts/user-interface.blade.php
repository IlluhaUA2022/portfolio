...
<div class="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
    <div class="grid gap-5 row-gap-8 lg:grid-cols-2">
        <div class="flex flex-col justify-center">
            <div class="max-w-xl mb-6">
                <h2 class="max-w-lg mb-6 font-sans text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl sm:leading-none">
                    A <span class="text-yellow-500">user interface</span> designed for the classroom
                </h2>
            </div>
            <div class="grid gap-5 row-gap-8 sm:grid-cols-3">
                <div class="bg-white border-l-4 shadow-sm border-violet-800">
                    <div class="h-full p-5 border border-l-0 rounded-r">
                        <div class="flex-shrink bg-white rounded-full p-3 flex items-center justify-center">
        ...
        <div class="relative">
            <div style="background: #33EFA0" class="w-32 h-32 rounded-full absolute z-0 left-10 -top-12 animate-pulse"></div>
            ...
            <img class="relative object-scale-down w-full h-56 rounded sm:h-96 floating" src="img/vcall.png" alt=""  />
