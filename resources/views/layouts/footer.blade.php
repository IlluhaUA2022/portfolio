<footer class="mt-32 bg-sky-700">
    <div class="mx-auto">
        <div class="flex flex-row items-center justify-center">
            <div class="flex py-12 justify-center text-white items-center px-20">
                <div class="relative">
            ...
            <div class="text-center py-5">
                ...
                <div class="px-5 sm:px-0 flex items-center flex-col sm:flex-row sm:space-x-3 space-y-3 sm:space-y-0 justify-center mt-3">
                    ...
                    <button class="text-white w-40 sm:w-auto mx-auto sm:mx-0 font-semibold px-5 py-2 rounded-full bg-gradient-to-br from-green-500 to-blue-500 ">Subscribe</button>
                </div>
            </div>
        </div>
        <div>
