<div class="bg-cyan-600 text-emerald-400">
    <div class="max-w-screen-xl px-8 mx-auto flex flex-col lg:flex-row items-start">
        <!--Left Col-->
        <div class="flex flex-col w-full lg:w-1/2 justify-center lg:pt-24 items-start text-center lg:text-left mb-5 md:mb-0">
            <h1  class="my-4 mt-4 text-5xl font-bold leading-tight text-darken">
                <span class="text-yellow-500">Studying</span> Online is now much easier
            </h1>
            <p class="leading-normal text-2xl mb-8">Skilline is an interesting platform that will teach you in more an interactive way</p>
            <div class="w-full md:flex mt-8 items-center justify-center lg:justify-start md:space-x-5">
        ...
        <div class="w-full lg:w-6/12 lg:-mt-10 relative" id="girl">
            <img class="w-10/12 mx-auto 2xl:-mb-20" src="img/girl.png" />
            <!-- calendar -->
            <div class="absolute top-20 -left-6 sm:top-32 sm:left-10 md:top-40 md:left-16 lg:-left-0 lg:top-52 animate-bounce w-30 h-7">
                <img class="bg-white bg-opacity-80 rounded-lg h-12 sm:h-16" src="img/calendar.svg">
            </div>
            <!-- red -->
            <div class="absolute top-20 right-10 sm:right-24 sm:top-28 md:top-36 md:right-32 lg:top-32 lg:right-16 animate-bounce w-30 h-4">
            ...
            <!-- ux class -->
            <div class="absolute bottom-40 -left-4 sm:left-2 sm:bottom-40 lg:bottom-40 lg:-left-4 animate-bounce w-30 h-10">
                <img class="bg-white bg-opacity-80 rounded-lg h-20 sm:h-28" src="img/ux-class.svg" alt="">
            </div>
            <!-- congrats -->
            <div class="absolute md:bottom-48 sm:bottom-52 lg:bottom-52 -right-2 lg:right-8 animate-bounce w-30 h-7">
